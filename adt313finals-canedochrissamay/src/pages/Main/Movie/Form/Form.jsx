  ...
  const handleSearch = useCallback(() => {
    ...
    axios.get(`https://api.themoviedb.org/3/search/movie?query=${query}&include_adult=false&language=en-US&page=${currentPage}`, {
      headers: {
        ...
        Authorization:  'Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiI3YWZjOTRkNmFmMDhiNmU2OWY0ZWY1NTk3YTRhMWYyMyIsIm5iZiI6MTczMzM2MzE4OC44MzIsInN1YiI6IjY3NTEwNWY0ZjU5Zjg0NjQwMGNiNDMwMSIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.pF-8iQ_wwKQt9w7LVVU2YGv_pJYB9bEktz8AAgpF1Mo',
      },
    })
      .then((response) => {
